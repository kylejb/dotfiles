function Set-OhMyPosh-Theme {
  $DotfilesOhMyPoshThemePath = Join-Path -Path $DotfilesWorkFolder -ChildPath "windows" | Join-Path -ChildPath "WindowsTerminal" | Join-Path -ChildPath ".oh-my-posh-custom-theme.omp.json";
...
function Set-PowerShell-Profile {
  $DotfilesWindowsTerminalProfilePath = Join-Path -Path $DotfilesWorkFolder -ChildPath "windows" | Join-Path -ChildPath "WindowsTerminal" | Join-Path -ChildPath "Powershell_profile.ps1";
